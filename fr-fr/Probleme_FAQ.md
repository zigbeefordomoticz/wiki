...
* Si le coordinateur est branché directement sur un port USB du serveur, essayez de le déporter en utilisant une rallonge USB. Ceci permettra de l'éloigner des interférences.
