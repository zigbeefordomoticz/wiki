...
Si les 4 groupes n'existent plus (ou on été supprimés), il est possible d'activer le paramètre `zigatePartOfGroupTint` et redémarrer le plugin. Les groupes seront automatiquement recréés.
