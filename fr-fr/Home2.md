...
|---------------------------------------------|---------------|
| * Étape 1 [Installation du Plugin](Plugin_Installation.md) | * [Mettre à jour le Plugin](Plugin_Mise-a-jour.md#mettre-à-jour-le-plugin)|
| * Étape 2 [Paramétrage du Plugin](Plugin_Parametrage.md) | * [Les branches de mises à jour](Plugin_Mise-a-jour.md#les-branches-de-mise-à-jour) |
