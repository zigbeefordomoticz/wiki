Doel van deze pagina is een om overzicht te geven van apparaten welke **Getest** zijn met de Zigate USB/WIFI en de Zigate plugin.
...
| Apparaat/Type | Gebruik door Domoticz | Beschrijving | Status | Plugin Versie |
| ----------- | -------------- | ----------- | ------ | -------------- |
| shutter | Blind percentage inverted switch | can command the shutter from the domoticz switch, but also you can pull shutter status and update the Domoticz Apparaat. | Fully operationnal | 2.3.5 | 
...
| Aqara WXKG11LM Square Apparaat with round Button | Switch Selector | The following events are reported to the Domoticz Switch selectors : 1 Click, 2 Click, 3 Click, 4 CliCk | Fully operationnal | 3.1.0 |
